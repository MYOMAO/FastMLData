...
Initialdir=/direct/sphenix+tg+tg01/hf/zshi/TrackletEff/JobSub
...
#Output=/tmp
Output=/direct/sphenix+tg+tg01/hf/zshi/TrackletEff/JobSub/out/job.$(Cluster).out
...
Error=/direct/sphenix+tg+tg01/hf/zshi/TrackletEff/JobSub/err/job.$(Cluster).err
...
Log=/direct/sphenix+tg+tg01/hf/zshi/TrackletEff/JobSub/log/myjob.$(Cluster).log
