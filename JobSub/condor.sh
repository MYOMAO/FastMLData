...
Initialdir=/direct/sphenix+tg+tg01/hf/zshi/FastMLData/JobSub
...
#Output=/tmp
Output=/direct/sphenix+tg+tg01/hf/zshi/FastMLData/JobSub/out/job.$(Cluster).out
...
Error=/direct/sphenix+tg+tg01/hf/zshi/FastMLData/JobSub/err/job.$(Cluster).err
...
Log=/direct/sphenix+tg+tg01/hf/zshi/FastMLData/JobSub/log/myjob.$(Cluster).log
