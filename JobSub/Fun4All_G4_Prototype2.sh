...
mv DebugFile.root /direct/sphenix+tg+tg01/hf/zshi/HFMLDataSample/ROOT/DebugFile_${Run}_${Seg}.root
mv TestZZData.json /direct/sphenix+tg+tg01/hf/zshi/HFMLDataSample/JSON/Data_${Run}_${Seg}.json
